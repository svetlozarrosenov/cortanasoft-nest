...
export const PERMISSIONS_CONFIG: ModulePermission[] = [
  ...
  {
    key: 'production',
    labelKey: 'modules.production.title',
    icon: 'Hammer',
    pages: [
      {
        key: 'bom',
        labelKey: 'modules.production.bom',
        actions: ['view', 'create', 'edit', 'delete'],
        tables: [
          {
            key: 'bomList',
            labelKey: 'modules.production.bomList',
            columns: [
              { key: 'name', labelKey: 'common.name' },
  ...
  },
  {
    ...
    pages: [
      ...
      {
        // Настройки > AI (Anthropic ключ на компанията) — отделно право,
