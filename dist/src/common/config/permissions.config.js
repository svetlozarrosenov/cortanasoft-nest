...
exports.PERMISSIONS_CONFIG = void 0;
exports.createEmptyPermissions = createEmptyPermissions;
exports.createFullPermissions = createFullPermissions;
exports.stripAdminModuleFromPermissions = stripAdminModuleFromPermissions;
exports.PERMISSIONS_CONFIG = [
    {
        key: 'dashboard',
...
function createEmptyPermissions() {
    ...
    for (const module of exports.PERMISSIONS_CONFIG) {
...
function stripAdminModuleFromPermissions(permissions) {
