...
exports.CompanyPlansModule = CompanyPlansModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [company_plans_controller_1.CompanyPlansController],
        providers: [company_plans_service_1.CompanyPlansService],
        exports: [company_plans_service_1.CompanyPlansService],
    })
], CompanyPlansModule);
